...
public class CategoriaController {
  ...
  public @ResponseBody String addNewUser (@RequestParam String categoria
  ...
  public @ResponseBody Iterable<Categoria> getCategoria(@RequestParam(value = "categoria") String categoria) {
