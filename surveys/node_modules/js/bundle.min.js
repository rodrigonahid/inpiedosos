var SelectPure = (function () {
    ...
    var c = { value: "data-value", disabled: "data-disabled", class: "class", type: "type" },
        r = (function () {
            function t(n) {
    ...
    return (function () {
        function t(n, i) {
            e(this, t),
                (this._config = o(o({}, i), {}, { classNames: o(o({}, u), i.classNames), disabledOptions: [] })),
                ...
                },
                {
                    ...
                    value: function (e) {
                        ...
                        (this._parent = new r(t)),
                            (this._select = new r("div", { class: this._config.classNames.select })),
                            (this._label = new r("span", { class: this._config.classNames.label })),
                            (this._optionsWrapper = new r("div", { class: this._config.classNames.dropdown })),
                            ...
                            (this._placeholder = new r("span", { class: this._config.classNames.placeholder, textContent: this._config.placeholder })),
                    ...
                    value: function () {
                        ...
                        return (
                            this._config.autocomplete &&
                                ((this._autocomplete = new r("input", { class: this._config.classNames.autocompleteInput, type: "text" })),
                            ...
                            this._config.options.map(function (t) {
                                var n = new r("div", { class: "".concat(e._config.classNames.option).concat(t.disabled ? " " + e._config.classNames.optionDisabled : ""), value: t.value, textContent: t.label, disabled: t.disabled });
                ...
                },
                {
                    ...
                    value: function (e, t, n) {
                        ...
                        if (!(this._config.disabledOptions.indexOf(e) > -1)) {
                            if (
                                (e && !n && (this._config.value = this._config.multiple ? [].concat(a(this._config.value || []), [e]) : e),
                        ...
                        this._label.setText(""),
                            (this._icons = e.map(function (e) {
                                var t = new r("span", { class: n._config.classNames.selectedLabel, textContent: e.label }),
                                    i = new r(n._config.inlineIcon ? n._config.inlineIcon.cloneNode(!0) : "i", { class: n._config.icon, value: e.value });
